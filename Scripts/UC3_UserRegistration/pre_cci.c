# 1 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c"
...
# 1 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c" 2
...
# 2 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"4c8f873adb3a4b70a5e19c8618560a7d\",\"statu"
...
# 3 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c" 2
...
# 4 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c" 2
...
Action()
{
	...
	while(iteration < countLines) 
	{
		...
		strcpy(codeBuffer, lr_eval_string("{code}"));
		lr_save_string(codeBuffer, "codeBuffer");
		strcpy(numberBuffer, lr_eval_string("{number}"));
		lr_save_string(numberBuffer, "numberBuffer");
		strcpy(emailBuffer, lr_eval_string("{email}"));
...
# 5 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c" 2
...
# 6 "p:\\programs\\itogovoe\\scripts\\uc3_userregistration\\\\combined_UC3_UserRegistration.c" 2
